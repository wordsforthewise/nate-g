...
In fact, this is a recurring theme I'm finding in anti-marijuana campaigns--making a big deal about things increasing from 0.1% to 0.12%.  Another example is fatal car accidents which were claimed to be related to marijuana (I'm not sure if they tested blood for THC or Cannabinol levels--there is a BIG difference in what the two mean), which doubled recently from something like 37 to 74 per year (2013-2014).  With a state population of about 5 million people in CO, that's an absolute increase of 0.0007% to 0.00148%.  Watch out, it's an epidemic!
